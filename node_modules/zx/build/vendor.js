  ...
  "node_modules/yaml/dist/stringify/stringify.js"(exports) {
    ...
    function getTagObject(tags, item) {
      ...
      if (identity2.isScalar(item)) {
        obj = item.value;
        const match = tags.filter((t4) => t4.identify?.(obj));
...
var require_compose_scalar = __commonJS({
  "node_modules/yaml/dist/compose/compose-scalar.js"(exports) {
    ...
    function findScalarTagByTest({ directives, schema }, value, token, onError) {
      const tag = schema.tags.find((tag2) => tag2.default && tag2.test?.test(value)) || schema[identity2.SCALAR];
      if (schema.compat) {
...
var As, n2, fi, O, be, X, ve, kt, bt, Cr, Ve, Wt, qt, Ot, ee, zt, Ne, He, It, pr, di, $s, hi, pi, Ds, ut, Ms, Us, On, Et, xs, Ns, bi, Hs, mi, zn, Me, br, Un, ft, xn, G, mr, yi, yr, Qs, Ys, Gs, Zs, H, Nn, Ue, Fn, Ks, gi, Js, Xs, gr, jn, Pr, ye, tl, Ln, se, xe, le, rl, Si, nl, $2, At, ll, vr, dt, ul, Hn, _r, fl, cl, $n, dl, hl, pl, bl, wi, Ri, Er, Sr, ml, Ci, Dn, Bi, ki, Wi, wr, Vn, pt, Tr, Mn, zi, El, Al, Fi;
var init_node = __esm({
  "node_modules/node-fetch-native/dist/node.mjs"() {
    "use strict";
    init_node_fetch_native_1a4a356d();
...
var substitute = (arg) => typeof arg?.stdout === "string" ? arg.stdout.replace(/\n$/, "") : `${arg}`;
...
var buildSpawnOpts = ({ spawnOpts, stdio, cwd, shell, input, env: env2, detached, signal }) => ({
  ...spawnOpts,
  env: env2,
  cwd,
  stdio,
...
var buildSpawnOpts2 = ({ spawnOpts, stdio, cwd, shell, input, env: env2, detached, ac: { signal } }) => ({
  ...spawnOpts,
  env: env2,
  cwd,
  stdio,
...
var formatOutput = (data) => data.reduce((m2, d2) => {
  const pid = d2.PID?.[0] || d2.ProcessId?.[0];
  const ppid = d2.PPID?.[0] || d2.ParentProcessId?.[0];
...
export {
  YAML,
  buildCmd,
  source_default as chalk,
  depseekSync as depseek,
  exec,
  fs5 as fs,
  glob,
  globbyModule,
  export_minimist as minimist,
  s as nodeFetch,
  parseLine,
  ts_default as ps,
  export_which as which
};
